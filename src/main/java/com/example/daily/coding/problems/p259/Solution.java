...
package com.example.daily.coding.problems.p259;
...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        //0, 1, 3, 4, 2, 7, 5, 6, 8, 9
        arr = new Integer[]{0, 1, 3, 4, 2, 7, 5, 6, 8, 9};
        System.out.println(findSmallestWindow(arr)); // (2, 7) 
